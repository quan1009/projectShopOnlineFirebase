...
class _HomePageState extends State<HomePage> {
  ...
  Widget _buildDressIcon() {
    List<CategoryIcon> dressIcon = categoryProvider.getLaptopIcon;
    List<Product> dress = categoryProvider.getLaptopList;
    return Row(
  ...
  Widget _buildShirtIcon() {
    List<Product> shirts = categoryProvider.getMobileList;
    List<CategoryIcon> shirtIcon = categoryProvider.getMobileIconData;
    return Row(
  ...
  Widget _buildShoeIcon() {
    List<CategoryIcon> shoeIcon = categoryProvider.getMouseIcon;
    List<Product> shoes = categoryProvider.getmouseList;
    return Row(
  ...
  Widget _buildPantIcon() {
    List<CategoryIcon> pantIcon = categoryProvider.getRamIcon;
    List<Product> pant = categoryProvider.getRamList;
    return Row(
  ...
  Widget _buildTieIcon() {
    List<CategoryIcon> tieIcon = categoryProvider.getVgaIcon;
    List<Product> tie = categoryProvider.getVgaList;
    return Row(
  ...
  void getCallAllFunction() {
    categoryProvider.getMobileData();
    categoryProvider.getLaptopData();
    categoryProvider.getMouseData();
    categoryProvider.getRamData();
    categoryProvider.getVgaData();
    categoryProvider.getLaptopIconData();
