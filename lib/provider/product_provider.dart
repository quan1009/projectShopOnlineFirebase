...
class ProductProvider with ChangeNotifier {
  ...
  Future<void> getUserData() async {
    ...
    userSnapShot.docs.forEach(
      (element) {
        if (currentUser.uid == element["UserId"].data()) {
          userModel = UserModel(
              userAddress: element["UserAddress"].data(),
              userImage: element["UserImage"].data(),
              userEmail: element["UserEmail"].data(),
              userGender: element["UserGender"].data(),
              userName: element["UserName"].data(),
              userPhoneNumber: element["UserNumber"].data());
